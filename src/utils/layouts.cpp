...
void Layout::initWidgets(const vector<Widget*>& wgts) {
	clear(widgets);
	widgets = wgts;
...
Popup::Popup(const cvec2<Size>& relSize, const vector<Widget*>& children, BCall kcall, BCall ccall, bool vertical, int spacing) :
